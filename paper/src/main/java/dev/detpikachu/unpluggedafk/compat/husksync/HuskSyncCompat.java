 ...
 * its teardown, kept only for a {@code Reason.PLAYER_RETURNED} removal because that is the one teardown the
 ...
 * unreached and {@link HuskSyncListener#onSyncComplete} then writes the zero through NMS, which never calls
 * {@code die()}.
 *
