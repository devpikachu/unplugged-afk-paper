 ...
 *
 * <p>Obtain an {@link dev.detpikachu.unpluggedafk.api.UnpluggedAfkApi} through Bukkit's services manager rather than by
 * constructing one:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>A null registration means Unplugged AFK is absent or disabled, which callers should treat as "nobody is unplugged"
 * rather than as an error. Declaring Unplugged AFK under {@code softdepend} in your {@code plugin.yml} guarantees it
 * has enabled first if it is installed at all.
 *
